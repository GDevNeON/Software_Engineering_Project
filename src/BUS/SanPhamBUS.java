...
public class SanPhamBUS {
    ...
    public boolean updateQuantity1(int masp, int soluong) {
        SanPhamBUS spBUS = new SanPhamBUS();
        SanPhamDTO sp = spBUS.spDAO.selectById(String.valueOf(masp));
    ...
    public boolean subtractQuantity(int masp, int soluong) {
        ...
        SanPhamDTO sp = getByMaSP(masp);
        System.out.println("From sanpham: " + sp.getMasp() + " " + sp.getSoluongton());
        if (sp != null) {
    ...
    public boolean subtractQuantity2(int masp, int soluong) {
        // Lấy thông tin sản phẩm từ cơ sở dữ liệu dựa trên mã sản 
        SanPhamBUS spBUS = new SanPhamBUS();
        SanPhamDTO sp = spBUS.spDAO.selectById(String.valueOf(masp));
