...
//     
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == chiTietBtn) {
            if (!nqBUS.checkQuyen(listct, 6, "view")) {
        ...
        if (e.getSource() == themBtn) {
            if (!nqBUS.checkQuyen(listct, 6, "add")) {
        ...
        if (e.getSource() == xoaBtn) {
            if (!nqBUS.checkQuyen(listct, 6, "delete")) {
                ...
                if (index != -1) {
                    ...
                    if (id == 1 || id == 2 || id == 3 || id == 4 || id == 5) {
                        JOptionPane.showMessageDialog(main, "Bạn không thể xóa các quyền mặc định");
                        return;
                    }
        ...
        if (e.getSource() == suaBtn) {
            if (!nqBUS.checkQuyen(listct, 6, "edit")) {
                ...
                if (index != -1) {
                    int id = (int) quyenTable.getValueAt(index, 0);
                    if (login.t.getManhomquyenaccount() != 1 && (id == 1 || id == 4)) {
