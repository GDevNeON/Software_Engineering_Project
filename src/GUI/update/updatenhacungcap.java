...
public class updatenhacungcap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(78, 158, 209));
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        try {
            ...
            if(!v.isValidName(txttenncc.getText())){
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đúng định dạng tên nhà cung cấp");
                return;
            }  
            if (!v.isValidPhoneNumber(txtsodt.getText())) {
            ...
            if(!v.isValidAddress(txtdiachi.getText())){
