...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(51, 178, 229));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 500, 40));

        jLabel1.setBackground(new java.awt.Color(204, 245, 248));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/giohang.png"))); // NOI18N
        jLabel1.setFocusTraversalPolicyProvider(true);
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 330, 320));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 440));

        jPanel2.setBackground(new java.awt.Color(51, 178, 255));
        ...
        jLabel5.setText("Nhập mã nhân viên");
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, 40, 39));
        ...
        jPanel2.add(disable, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 40, 40));
        ...
        jPanel2.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 40, 40));
            ...
            if (tk == null) {
                ...
                if (tk.getTrangthai() == 0) {
                    ...
                    if (passwordCheck.equals(tk.getMatkhau())) {
                        ArrayList<ChiTietQuyenDTO> ctq = ctqBUS.selectAllByQuyenId(tk.getManhomquyen());
                        
                        t.setCtquyenaccount(ctq);
                        t.setMaaccount(tk.getManv());
                        t.setManhomquyenaccount(tk.getManhomquyen());
                        t.setTennhomquyenaccount(nqBUS.getNameById(tk.getManhomquyen()));
                        ...
                        NhanVienDTO nhanvien=nvDAO.selectById(usernameCheck);
                        System.out.println(nhanvien.getHoten());
                        Session.setNv(nhanvien);
                        System.out.println("Tên nhân viên đang đăng nhập"+ Session.getNv().getHoten());
                        if (tk.getManhomquyen() == nq.getManhomquyen() && nq.getTennhomquyen().equalsIgnoreCase("Nhân viên mới")) {
