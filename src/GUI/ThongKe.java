...
//        tblphieuxuat.setDefaultEditor(Object.class, null);
    ...
    public final void initTableDt() {
        ...
        String[] headerTbl = new String[]{"Tên sản phẩm", "Giá nhập", "Giá bán", "Số lượng bán", "Doanh thu", "Lợi nhuận", "Thời gian"};
    ...
    public final void initTableSp() {
        ...
        String[] headerTbl = new String[]{"Mã Sản Phẩm ", "Tên Sản Phẩm", "Số lượng tồn", "Giá nhap", "Giá bán"};
        ...
        try {
            ...
            for (DoanhThuDTO x : dt) {
                tblModeldt.addRow(new Object[]{
                    x.getTensp(), x.getGianhap(), x.getGiaban(), x.getSoluongban(), x.getDoanhthu(),
        ...
        try {
            ...
            for (SanPhamDTO i : sp) {
                tblModelsp.addRow(new Object[]{
                    i.getMasp(), i.getTensp(), i.getSoluongton(), i.getGianhap(), i.getGiaban()
                });
            }
        } catch (Exception e) {
            ...
            layout.setHorizontalGroup(
                  ...
                  .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                              ...
                              .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 1108, Short.MAX_VALUE))
                        .addContainerGap())
            );
