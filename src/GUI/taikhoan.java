...
public class taikhoan extends javax.swing.JPanel {
    ...
    public NhomQuyenBUS nqBUS = new NhomQuyenBUS();
    ...
    public void loadDataToTable(ArrayList<TaiKhoanDTO> list) {
        ...
        for (TaiKhoanDTO taiKhoanDTO : list) {
            ...
            tblModel.addRow(new Object[]{
                taiKhoanDTO.getManv(),
                nqBUS.getNameById(taiKhoanDTO.getManhomquyen()),
                trangthaiString
            });
        }
    }
      ...
      private void initComponents() {
            ...
            jPanel2Layout.setHorizontalGroup(
                  ...
                  .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cbxLuachon, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        if (!nqBUS.checkQuyen(listct, 8, "delete")) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {
        if (!nqBUS.checkQuyen(listct, 8, "add")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
        if (!nqBUS.checkQuyen(listct, 8, "edit")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
            if (tblTaiKhoan.getSelectedRow() == -1) {
