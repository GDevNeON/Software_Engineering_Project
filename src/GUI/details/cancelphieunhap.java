 ...
 * @author NeON
 */
public class cancelphieunhap extends javax.swing.JDialog {

    private phieunhap parent;
    PhieuNhapBUS pnBUS = new PhieuNhapBUS();
    SanPhamBUS spBUS = new SanPhamBUS();

    public cancelphieunhap(phieunhap parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
    ...
    public cancelphieunhap() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public cancelphieunhap(JFrame jFrame, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    private void btnHuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyActionPerformed
        try {
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                System.out.println("From phieunhap: " + masp + " " +  soluong);
                // Trừ số lượng tồn kho của sản phẩm
                boolean updateSuccess = spBUS.subtractQuantity(masp, soluong);
                if (!updateSuccess) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                cancelphieunhap dialog = new cancelphieunhap(new javax.swing.JFrame(), true);
