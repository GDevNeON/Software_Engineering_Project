...
public class addnhanvien extends javax.swing.JDialog {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            ...
            if (hoten.isEmpty() || email.isEmpty() || sdt.isEmpty() || gioitinh == null || date == null) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            } else if (!v.isValidName(hoten)){
                  JOptionPane.showMessageDialog(this, "Họ tên nhân viên không hợp lệ!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                ...
                if (!nvBUS.nhanVienDAO.checkExistingData(nv)) {
                      nvBUS.add(nv);
                ...
                this.dispose();
                      ...
                      JOptionPane.showMessageDialog(this, "Dữ liệu đã tồn tại trong CSDL !", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            }
