 ...
 * @author NeON
 */
public class addkho extends javax.swing.JDialog {

      private final KhoHangBUS khBUS = new KhoHangBUS();
      private final Validation v = new Validation();

      public addkho(javax.swing.JFrame parent, boolean modal) {
            super(parent, modal);
            initComponents();
            setModal(modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("THÊM KHU VỰC KHO");
    ...
    private void btnthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemActionPerformed
          ...
          try {
                ...
                } else if (!v.isValidName(tenkvk)) {
                      JOptionPane.showMessageDialog(this, "Tên khu vực kho phải đúng định dạng !");
                } else if (!v.isValidAddress(ghichu)) {
                      JOptionPane.showMessageDialog(this, "Ghi chú phải đúng định dạng !");
                } else {
    ...
    private void btnhuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhuyActionPerformed
      ...
      public static void main(String args[]) {
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                  public void run() {
                        addkho dialog = new addkho(new javax.swing.JFrame(), true);
