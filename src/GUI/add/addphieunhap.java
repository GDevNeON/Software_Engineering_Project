...
public class addphieunhap extends javax.swing.JPanel {
      ...
      private void initComponents() {
            ...
            setPreferredSize(new java.awt.Dimension(1000, 471));

            jPanel1.setBackground(new java.awt.Color(255, 255, 255));

            jLabel11.setText("Nhập tên nhà cung cấp");
            ...
            tblphieunhapin.setRowHeight(50);
            tblphieunhapin.setSelectionBackground(new java.awt.Color(176, 212, 235));
            tblphieunhapin.setSelectionForeground(new java.awt.Color(10, 0, 0));
            ...
            jLabel5.setText("Tỉ lệ lợi nhuận (%)");
            ...
            jLabel14.setText("Nhập tìm kiếm sản phẩm");

            jLabel15.setText("Chọn mục");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                          ...
                                          .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                      ...
                                                      .addComponent(cbtenncc, 0, 189, Short.MAX_VALUE))
                              ...
                              .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                          ...
                                          .addComponent(txtloinhuan, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            jPanel1Layout.setVerticalGroup(
                  ...
                  .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                              .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addGap(22, 22, 22)
                                    .addComponent(cbtenncc, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                              .addComponent(jLabel12)
                              .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel14)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            tblphieunhapout.setRowHeight(50);
            tblphieunhapout.setSelectionBackground(new java.awt.Color(176, 212, 235));
            tblphieunhapout.setSelectionForeground(new java.awt.Color(10, 0, 0));
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                              ...
                              .addGroup(jPanel6Layout.createSequentialGroup()
                                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                          ...
                                          .addComponent(txttennvnhap, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGap(18, 18, 18)
                                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                          .addComponent(jLabel10)
                                          .addComponent(combomakhuvuc, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGap(18, 18, 18)
                                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                          .addGroup(jPanel6Layout.createSequentialGroup()
    ...
    private void btnthemspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemspActionPerformed
          ...
          try {
                ...
                if (gianhap <= 0 || gianhap >= 10000000) {
                      throw new NumberFormatException();
                }
          } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập giá nhập hợp lệ.", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
          }

          int tileloinhuan;
          try {
                tileloinhuan = Integer.parseInt(txtloinhuan.getText().trim());
                if (tileloinhuan <= 0 || tileloinhuan > 90) {
                      throw new NumberFormatException();
                }
          } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập tỉ lệ lợi nhuận từ 1 đến 90", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
          }

          // Tính giá bán như kiểu double
          double giabanDouble = gianhap + (tileloinhuan / 100.0) * gianhap;

          // Làm tròn giá bán và chuyển đổi thành int
          int giaban = (int) Math.round(giabanDouble);
    ...
    private void btnnhaphangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnhaphangActionPerformed
          try {
                ...
                int mancc = 1;
                int manv = 1;
                String tenncc = "" + cbtenncc.getSelectedItem();
                for (NhaCungCapDTO i : listTenncc) {
                      if (tenncc.equalsIgnoreCase(i.getTenncc())) {
                            mancc = i.getMancc();
                            break;
                      }
                }
                String tennv = "" + txttennvnhap.getText();
                ...
                for (int i = 0; i < rowCount; i++) {
                      ...
                      int giaban = (int) model.getValueAt(i, 4);
...
//                sp.setSoluongton(sp.getSoluongton() + soluong);
                      ...
                      LoHangDTO lh = new LoHangDTO(mapn, masp, soluong, dongia, giaban);
                      pnBUS.lhDAO.insert(lh);
                }
