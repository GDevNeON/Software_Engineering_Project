...
public final class nhacungcap extends javax.swing.JPanel {
    ...
    @SuppressWarnings("unchecked")
      ...
      private void initComponents() {
            ...
            jPanel11.setBackground(new java.awt.Color(176, 212, 235));
            jPanel11.setPreferredSize(new java.awt.Dimension(1150, 410));
            ...
            tablencc.setSelectionBackground(new java.awt.Color(176, 212, 235));
            tablencc.setSelectionForeground(new java.awt.Color(10, 0, 0));
            ...
            jPanel13Layout.setHorizontalGroup(
                  ...
                  .addGroup(jPanel13Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jToolBar4, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 260, Short.MAX_VALUE)
                        .addComponent(cbxChoose, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20)
            ...
            jPanel11Layout.setHorizontalGroup(
                  ...
                  .addComponent(jPanel13, javax.swing.GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE)
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if (!nqBUS.checkQuyen(listct, 3, "view")) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        if (!nqBUS.checkQuyen(listct, 3, "delete")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
            if (tablencc.getSelectedRow() == -1) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (!nqBUS.checkQuyen(listct, 3, "edit")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
            if (tablencc.getSelectedRow() == -1) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (!nqBUS.checkQuyen(listct, 3, "add")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
