...
public class khachhang extends javax.swing.JPanel {
      ...
      private void initComponents() {
            ...
            jPanel2Layout.setHorizontalGroup(
                  ...
                  .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jToolBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (!nqBUS.checkQuyen(listct, 1, "edit")) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        if (!nqBUS.checkQuyen(listct, 1, "delete")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
            if (jTable1.getSelectedRow() == -1) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (!nqBUS.checkQuyen(listct, 1, "add")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
    ...
    private void btnChitietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChitietActionPerformed
        if (!nqBUS.checkQuyen(listct, 1, "view")) {
            btnThem.setBackground(Color.gray);
            JOptionPane.showMessageDialog(this, "Bạn không có đủ quyền hạn để sử dụng chức năng này !");
        } else {
            if (jTable1.getSelectedRow() == -1) {
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        switch (choose) {
            case "Tất cả":
                result = SearchKhachHang.getInstance().searchTatCa(text);
                break;
            case "Mã khách hàng":
                result = SearchKhachHang.getInstance().searchMaKH(text);
                break;
            case "Tên khách hàng":
                result = SearchKhachHang.getInstance().searchTenKH(text);
                break;
            case "Địa chỉ":
                result = SearchKhachHang.getInstance().searchDiaChi(text);
                break;
            case "Giới tính":
                result = SearchKhachHang.getInstance().searchGioiTinh(text);
                break;
            case "Số điện thoại":
                result = SearchKhachHang.getInstance().searchSDT(text);
            case "Ngày tham gia":
                result = SearchKhachHang.getInstance().searchThoiGian(text);
        }
