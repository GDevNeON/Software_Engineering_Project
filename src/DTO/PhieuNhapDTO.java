...
public class PhieuNhapDTO {
    ...
    public PhieuNhapDTO(int maphieu, int mancc, String tenncc, int manv, String tennvnhap, Date thoigiantao,
            long tongtien) {
    ...
    public String toString() {
        return "PhieuNhapDTO{" + "maphieunhap=" + maphieunhap + ", mancc=" + mancc + ", makhuvuc=" + makhuvuc
                + ", manv="
